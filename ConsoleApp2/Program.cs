...
namespace ConsoleApp2
{
    class Program
    {
        enum DialogResult {YES, NO, CANCEL, CONFURM=50, OK}
        static void Main(string[] args)
        {
            ...
            double b2 = (double)a; Console.WriteLine("b2:{0}", b2);
            ...
            Console.WriteLine((int)DialogResult.CONFURM);
            ...
            */
            ...
            Console.WriteLine("Type: {0}, Value: (1)", d6.GetType());
            foreach(var e in d6)
            {
